...
int main(int argc, char * argv[])
{
  ...
  if(1){
    ...
    point2.positions[1] = -1.0;
    point2.positions[2] = -1.0;
    point2.positions[3] = -1.0;
    point2.positions[4] = -1.0;
    ...
    point3.positions[1] = 1.0;
    point3.positions[2] = 1.0;
    point3.positions[3] = 1.0;
    point3.positions[4] = 1.0;
